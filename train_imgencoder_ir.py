...
------------------------------------------------------------------------------
"""
save_place = "./train_results/encoder_ir/img_encoder_ir_C8_16_32_64_transformer"
llvip = "C:/Users/root/Desktop/LLVIP/LLVIP/infrared/train"
...
for epoch in range(num_epochs):
    for i, (img, _, _) in enumerate(trainloader):
        img = img.cuda()
